...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="card">
            <form action="/admin/addNewPost" method="post" enctype="multipart/form">
                {{ Method_field('POST') }}
                @csrf
                <div class="card-body p-4">
                    ...
                    <div class="form-body mt-4">
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="border border-3 p-4 rounded">
                                    <div class="mb-3">
                                        <label for="inputProductTitle" class="form-label">Tiêu Đề Blog</label>
                                        <input type="text" name="title" class="form-control" id="inputProductTitle"
                                            placeholder="Nhập Tên Cây">
                                    </div>
                                    <div class="mb-3">
                                        <label for="inputProductDescription" class="form-label">Ảnh Tiêu Đề Blog</label>
                        ...
                        <div class="form-body mt-4">
                            <div class="mb-3">
                                <label for="inputProductDescription" class="form-label">Chi Tiết Bài
                                    Viết</label>
                                <textarea name="description" id="content" class="summernote form-control"></textarea>
                            </div>
                            <div class="mb-3">
                                <div class="d-grid">
                                    <button type="submit" class="btn btn-light">Thêm Sản Phẩm</button>
